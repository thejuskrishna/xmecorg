...
<TR>
	...
	<TD width=433>
<IMG src="images/dot1.gif">&nbsp;&nbsp;<A class=name name="news1"><strong>College Chapter.</strong></A>
...
<TR>
<TD bgcolor="#dddddd" width=113><P class=body><strong>Chapter Strength : 30<BR> <BR><A HREF="mailto:college@xmec.net" class=flink>Contact Us</A></strong></P></TD>
<TD bgcolor="#dddddd" width=320>
	<P class=body><strong>Executive Committee </strong></P>
	<UL><LI class=body>President: Manu Sreenivasan (1st batch)
        <LI class=body>Vice President:Anoop A (5th batch)
		<LI class=body>Secretary: Renish Pynadath (6th batch)
        <LI class=body>Joint Secretary:Aiswarya Krishna (8th batch)
        <LI class=body>Treasurer: MEC Staff Member</LI>
        <LI class=body>Editor: Johnson Joseph (10 Batch)</LI>
        <LI class=body>XMEC Moderator: Vyas Mohan Thottathil (5th Batch)</LI>
	</UL>
...
<A href="#top"><IMG align=right border=0 src="images/top.gif"></A>
...
<IMG src="images/dot1.gif">&nbsp;&nbsp;<A class=name name="news2"><strong>Bangalore Chapter </strong></A>
<HR width=433 color=#dddddd>
...
<TABLE border=0 cellPadding=5 cellSpacing=1 width="433">
<TR>
<TD bgcolor="#dddddd" width=143><P class=body><strong>Chapter Strength : 240<BR>
<BR><A HREF="mailto:blore@xmec.net" class=flink>Contact Us</A> </strong></P></TD>
...
<A href="#top"><IMG align=right border=0 src="images/top.gif"></A><BR><BR>
<TABLE border=0 cellPadding=0 cellSpacing=0 width="445">
<TR>
	<TD colspan=3><IMG src="images/tabletop.gif"></TD>
</TR>
...
<IMG src="images/dot1.gif">&nbsp;&nbsp;<A class=name name="news3"><strong>Chennai Chapter </strong></A>
<HR width=433 color=#dddddd>
...
<TABLE border=0 cellPadding=5 cellSpacing=1 width="433">
<TR>
<TD bgcolor="#dddddd" width=143><P class=body><strong>Chapter Strength : 100 <BR>
<BR><A HREF="mailto:chn@xmec.net" class=flink>Contact Us</A></strong></P></TD>
<TD bgcolor="#dddddd" width=290>
	<P class=body><strong>Working Committee </strong>
	<UL><LI class=body>Prinu Shaan Nazeem (6th batch)
   	<LI class=body>Lima Iype(7th batch) </LI>
		<LI class=body>Aswin Thomas Mathew(8th batch) </LI>
		<LI class=body>Cherian Thomas (9th batch) </LI>
		<LI class=body>Shanid Abdul Gafur (10th batch) </LI>
		<LI class=body>Manju Rose (10th batch) </LI>
	</UL>
...
<IMG src="images/dot1.gif">&nbsp;&nbsp;<A class=name name="news4"><strong>Hyderabad Chapter </strong></A>
<HR width=433 color=#dddddd>
<P class=body>Hyderabad chapter comprises all the XMECians who work and live in Hyderabad and other parts of Andhra Pradesh. Officially active on January 26<sup>th</sup> 2003, it is well known for it's overflowing exuberance. </P>

<TABLE border=0 cellPadding=5 cellSpacing=1 width="433">
<TR>
<TD bgcolor="#dddddd" width=143><P class=body><strong>Chapter Strength : 39 <BR>
<BR><A HREF="mailto:hyd@xmec.net" class=flink>Contact Us</A></strong></P></TD>
<TD bgcolor="#dddddd" width=290>
  <P class=body><strong>Chapter Coordinator</strong>
  <UL><LI class=body>Vyas Mohan Thottathil(5th batch)</LI>
  </UL>
...
<IMG src="images/dot1.gif">&nbsp;&nbsp;<A class=name name="news5"><strong>US East Coast Chapter </strong></A>
<HR width=433 color=#dddddd>
...
<TABLE border=0 cellPadding=5 cellSpacing=1 width="433">
<TR>
<TD bgcolor="#dddddd" width=143><P class=body><strong>Chapter Strength : 35 <BR>
<BR><A HREF="mailto:us_east@xmec.net" class=flink>Contact Us</A></strong></P></TD>
<TD bgcolor="#dddddd" width=290>
	<P class=body><strong>Working Committee</strong>
...
<IMG src="images/dot1.gif">&nbsp;&nbsp;<A class=name name="news6"><strong>US West Coast Chapter </strong></A>
<HR width=433 color=#dddddd>
...
<TABLE border=0 cellPadding=5 cellSpacing=1 width="433">
<TR>
<TD bgcolor="#dddddd" width=143><P class=body><strong>Chapter Strength : 51 <BR>
<BR><A HREF="mailto:us_west@xmec.net" class=flink>Contact Us</A></strong></P></TD>
<TD bgcolor="#dddddd" width=290>
	<P class=body><strong>Working Committee </strong>
...
<A href="#top"><IMG align=right border=0 src="images/top.gif"></A><BR><BR></TD>
  </TR>
</TABLE>
<!--center ends-->
<?php
