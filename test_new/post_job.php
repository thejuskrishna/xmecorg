...
<TR>
	<TD width="15%" class=name>Company</TD>
...
?>
	...
	<TD width="15%" class=name>Experience</TD>
	<TD width="35%">
<?php
		if ($action == "view_details") {
			echo $job[2] . " To " . $job[3];
...
<TR>
	<TD width="15%" class=name >Contact Name</TD>
	<TD height=20px>
<?php
		if ($action == "view_details") {
			echo $job[4];
...
?>
<!--Box Starts-->
<TD colspan = 2 class=head><B>XMEC Job Postings</B></TD>
