...
echo '<BODY TOPMARGIN=0 LEFTMARGIN=0 MARGINHEIGHT=0 MARGINWIDTH=0> */
	echo '<div align="center"><br/><br/><FORM METHOD="post" ACTION="caladmin.php">
	<TABLE cellspacing=0 cellpadding=0 width=80% height=422 border=0>
	<TR>
';
        if($user->isAdmin())
                $rights=2;
   ...
   {
       $content='You should have admin access to view this page. Please <a href="login.php">login</a> as admin and try again.';
