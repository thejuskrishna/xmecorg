...
<div align="center">
    <br/><br/>
    <h2>
  	One can send a message to the Alumni, Chapter(s) or any Batch that has graduated from Model Engineering College, Kochi. Your message will be delivered to the groups only on approval of the moderator of the respective Group or Mailing List.
    </h2>
    <br/>
    <TABLE cellSpacing=3 cellPadding=1 width=45% border=0>
        <form name="emails" method="post" action="mail.php">
            <INPUT TYPE="hidden" NAME="recipient" value="">
        <!--    <TABLE BORDER=0 cellpadding=5 cellspacing=0 bordercolor="#dddddd" width="90%">-->
            <TR>
                <TD class=name><B>To Mailing List</B></TD>
                <TD>
                    <SELECT NAME="list" onChange="displayinfo()" class=cbox style="width:225px;" >
            ...
            <TR>
                <TD class=body><B>From</B></TD>
                <TD>
                    <INPUT NAME="name" value="<?php echo $user->first_name ?> <?php echo $user->last_name ?>" type=text class=lbox style="width:225px;">
                </TD>
            </TR>
            <TR>
                <TD class=name><B>From Email ID</B></TD>
                <TD>
                    <INPUT NAME="sendcat" value="<?php echo $user->personal_email ?>" type=text class=lbox style="width:225px;">
                </TD>
            </TR>
            <TR>
                <TD class=name><B>Subject</B></TD>
                <TD>
                    <INPUT NAME="subject" type=text class=lbox style="width:225px">
                </TD>
            </TR>
            <TR>
                <TD>&nbsp;</TD>
            ...
            <TR>
                <TD class=name><B>Your Message</B></TD>
            </TR>
            <TR>
                <TD colspan=2><TEXTAREA class=tbox cols=60 name=message rows=10 wrap=virtual onfocus="javascript:canceltext();">Please select the group you want to send the message</TEXTAREA></TD>
            </TR>
            <TR>
                ...
                <TD width=275>
                    <INPUT type=hidden NAME="details" value="<?php echo $user->first_name ?> <?php echo $user->last_name ?> <?php echo $user->id ?>" type=text class=lbox style="width:225px;">
                </TD>
            </TR>
            <TR>
                <TD align=middle colspan=2><INPUT TYPE="Button" NAME="sendit" VALUE="Send" onclick="javascript:check();"></TD>
            </TR>
            <TR>
                <TD>&nbsp;</TD>
            </TR>
            <TR>
                <TD class=name align=middle colspan=2>
                    <A href="subscription.php" class=flink> Subscribe to XMEC Groups and Mailing Lists</A>
                </TD>
            </TR>
        </form>
    </TABLE>
