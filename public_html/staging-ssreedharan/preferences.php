<?php
  ...
  $admin = FALSE;
  if ($me->isAdmin() && isset($_POST['id']) && $id != "" && $_s == 1) {
    $admin = TRUE;
    $user = new XMEC_user($_POST['id']);
    if (!$user->fetchInfo()) {
...
<div align="center" id="pref_page" class="content">
...
<?php
  ...
  echo "<br><FONT face=arial size=2 color=\"#FF0000\">Failed updating preferences: $pass_st  $email_st  a:$addr_st</font><br>";
...
<TR>
  ...
  <TD align=right><INPUT class=lbox name=webpage value="<?=htmlentities($user->get('webpage'))?>"></TD>
</TR>
</TABLE><BR>
...
<!--Box Ends-->
<P>I want to update my Email IDs in the <a href="subscription.php" class=flink>Alumni Mailing Lists xmec@yahoogroups.com and xmec-jobs@yahoogroups.com</A>. Please note that this will take you out of the My Preferences page.</P>
</TR></TD>
<TR><TD>
