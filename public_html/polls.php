...
echo "<IMG src=\"poll_images/".$polls[$i]->pollID.".jpeg\" />";
...
?>
    <TR><TD>
      ...
      <FORM NAME=create_poll method=post action="polls.php" enctype="multipart/form-data">
...
$old_poll=& getAllPolls();
$pollID=$old_poll[count($old_poll)-1]->pollID+1;
 if( $_FILES['uploaded_image']['tmp_name']!="" ) {
      $img="poll_images/".$pollID.".jpeg";
