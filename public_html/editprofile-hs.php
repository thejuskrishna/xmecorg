...
?>
   ...
   <form action="editprofile-hs.php" method="post" enctype="multipart/form-data">
...
<TBODY>
	...
	<TD><SELECT class=cbox style="WIDTH: 150px" name=CBWork maxlength=20>
...
<form method=post action="editprofile-hs.php">
    <input type=hidden name=todo value=null>
